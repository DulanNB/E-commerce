...
Route::post('/contact/message','MessageController@send')->name('contact.store');
...
Route::get('/Terms&Conditions','FrontendController@Terms_Conditions')->name('Terms&Conditions');
