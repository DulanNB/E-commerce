...
@endsection
@section('title','Quotesalad || PRODUCT DETAIL')
												...
												<ul class="slides">
													...
													@foreach($photo as $data)
														<li data-thumb="{{$data}}" rel="adjustX:10, adjustY:">
															<img src="{{asset("img/product_images/$photo[0]")}}" alt="{{asset($data)}}">
														</li>
													@endforeach
												</ul>
											</div>
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="price"><span class="discount">Rs{{number_format($after_discount,2)}}</span>
													...
													@else
														<s>Rs {{number_format($product_detail->price,2)}}</s> </p>
													@endif
												...
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="select">
														@if($product_detail->size)
															...
															<label class="pull-left" for="size"><h5>Choose a size:</h5></label>
