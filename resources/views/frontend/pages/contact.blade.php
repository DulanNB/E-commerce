...
@section('main-content')
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li><a href="mailto:dultude@gmail.com">@foreach($settings as $data) {{$data->email}} @endforeach</a></li>
									</ul>
								</div>
								<div class="single-info">
	...
	<div class="map-section">
		<div id="myMap">
			<!--<iframe src="https://maps.google.com/maps?q=nalaka%20peper%20dehiwala&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>-->
		</div>
	</div>
