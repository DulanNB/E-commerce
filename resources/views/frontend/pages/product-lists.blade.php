                                ...
                                <div class="single-widget recent-post">
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            <div class="image">
                                                <img src="{{asset("img/product_images/$photo[0]")}}" alt="{{asset($photo[0])}}">
                                            </div>
                                            <div class="content">
													...
													<div class="single-product">
														<div class="product-img">
															...
															@php 
																$photo=explode(',',$product->photo);
															@endphp
															<img class="default-img" src="{{asset("img/product_images/$photo[0]")}}" alt="{{asset($photo[0])}}">
															<img class="hover-img" src="{{asset("img/product_images/$photo[0]")}}" alt="{{asset($photo[0])}}">
															</a>
